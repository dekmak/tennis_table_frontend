      ...
      <Grid spacing={{ xs: 6, md: 10 }} justifyContent="center" alignItems="center" container>
        <Grid item md={10} lg={8} mx="auto">
          ...
          <TypographyH1 sx={{ mb: 2 }} variant="h1">
            Tennis Table Scoring Application
          </TypographyH1>
          <TypographyH2
          ...
          <Grid container spacing={3} mt={5}>
            ...
            <Grid item md={6}>
              ...
              <Typography variant="h4">
                <Box sx={{ pb: 2 }}><b>Built with React</b></Box><Typography component="span" variant="subtitle2"> - Tennis Table Scoring Application is built with React + Javascript.</Typography>
              </Typography>
            </Grid>
          </Grid>
        </Grid>
